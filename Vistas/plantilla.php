...
<!-- JQVMap --><script src="Vistas/plugins/jqvmap/jquery.vmap.min.js"></script>
...
<!-- daterangepicker --><script src="Vistas/plugins/moment/moment.min.js"></script>
...
<!-- AdminLTE for demo purposes <script src="Vistas/dist/js/demo.js"></script>-->
<!-- sweetAlert2 --><script src="Vistas/js/sweetalert2.all.min.js"></script>
